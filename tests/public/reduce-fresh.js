...
suite('reduceFresh', () => {
  test('arrayLike', () => {
    const toTotal = (cumulativeResult, gameScore) => {
      ...
      calculateTotalScore = reduceFresh(toTotal, () => 0)
  ...
  test('map', () => {
    const toTotal = (cumulativeResult, caloriesForTheDay) => {
      ...
      calculateTotal = reduceFresh(toTotal, () => 0),
  ...
  test('set', () => {
    const toHandScore = (handScore, card) => {
      ...
      calculateHandScore = reduceFresh(toHandScore, () => 0)
